...
def get_volume_perimeter(Muscle, index):     
    #vertices_loop = []
...
def join_muscle(Muscle):
    ...
    # me = obj.data
    # bm = bmesh.from_edit_mesh(me)
    # bpy.context.active_object.vertex_groups.new(name='BOTH_ENDS_A')
    # for v in bm.verts:
    #     if v.select:
    #         bpy.ops.object.vertex_group_assign() 
